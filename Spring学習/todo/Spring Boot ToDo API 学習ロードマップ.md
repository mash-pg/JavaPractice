...
| 判断ポイント | 理由 | 参照 |
|-------------|------|------|
| **DTO 使用** | DB 構造と API 形式を分離、変更に強い | Phase 02 |
| **Repository Interface** | DB 変更・テスト時のモック対応 | Phase 06 |
| **Strategy パターン** | ソート処理を切り替え可能に（OCP） | Phase 09 |
| **Factory パターン** | 生成ルールを一箇所に集約 | Phase 09 |
...
- [[Spring学習/todo/Phase01 環境構築]]
- [[Spring学習/todo/Phase02 API設計]]
- [[Phase03 レイヤ設計（DDD 軽量版）]]
- [[Phase04 ドメインモデル設計]]
- [[Phase05 ユースケース]]
- [[Phase06 Repository]]
- [[Phase07 DB実装]]
